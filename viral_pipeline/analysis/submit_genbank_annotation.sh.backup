...
OUTPUT_DIR="/scratch/sahlab/kathie/genbank_annotations/${ACCESSION}"
...
$MAMBA_CMD python3 "${SCRIPT_DIR}/parse_genbank_annotations.py" "$GENBANK_FILE" --output-dir "$OUTPUT_DIR"
